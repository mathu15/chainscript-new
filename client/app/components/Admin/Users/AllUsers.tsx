      ...
      {isLoading ? (
        ...
        >
          ...
          {open && (
            ...
            >
              <Box className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[450px] dark:text-white bg-white dark:bg-slate-900 rounded-[8px] shadow p-4 outline-none">
                <h1 className={`${styles.title}`}>
                  Are you sure you want to delete this user?
                </h1>
                <div className="flex w-full items-center justify-between mb-6">
                  <div
                    className={`${styles.button} !W-[120px] h-[30px] bg-[#57c78c]`}
                    onClick={() => setOpen(!open)}
                  >
                    Cancel
                  </div>
                  <div
                    className={`${styles.button} !W-[120px] h-[30px] bg-[#d63f63]`}
