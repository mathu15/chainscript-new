      ...
      {data && data.length > 0 && data[activeVideo] && (
        <>
          ...
          <div className="w-full flex items-center justify-between my-3">
            ...
            >
              <AiOutlineArrowLeft className="mr-2 text-black dark:text-white" />
              Prev Lesson
            </div>
            <div
              className={`${
            ...
            >
              <AiOutlineArrowRight className="ml-2 text-black dark:text-white" />
              Next Lesson
            </div>
          </div>
          ...
          <br />
          <div className="w-full p-4 flex items-center justify-between text-black dark:text-white bg-slate-500 bg-opacity-20 backdrop-blur shadow-[bg-slate-700] rounded shadow-inner">
                              ...
                              item._id(
                                <div className="w-full flex relative">
                                  <input
                                    ...
                                    className={`block 800px:ml-12 mt-2 outline-none bg-transparent border-b text-black dark:text-white border-[#00000027] dark:border-[#fff] p-[5px] w-[95%]`}
                                  />
                                  <button
                                    type="submit"
